...
class TestQuestionsControllerTest < ActionController::TestCase
  ...
  test "should create test_question" do
    assert_difference('TestQuestion.count') do
      post :create, test_question: { question_id: @test_question.question_id, sort: @test_question.sort, test_id: @test_question.test_id }
    end
  ...
  test "should update test_question" do
    patch :update, id: @test_question, test_question: { question_id: @test_question.question_id, sort: @test_question.sort, test_id: @test_question.test_id }
    assert_redirected_to test_question_path(assigns(:test_question))
  end
